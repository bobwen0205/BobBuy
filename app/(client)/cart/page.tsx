                  ...
                  <div className="border bg-white rounded-md">
                    {cartProducts?.map(({ product }) => {
                      ...
                      return (
                        <div
                          key={product?._id}
                          className="border-b p-2.5 last:border-b-0 flex items-center justify-center gap-5"
                        >
                          <div className="flex flex-1 items-center gap-2 h-36 md:h-44">
                            ...
                            <div className="h-full flex flex-1 items-start flex-col justify-between">
                              ...
                              <div className="text-gray-500 flex items-center gap-2">
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger>
                                      <Heart
                                        className="w-4 h-4 md:w-5 md:h-5 hover:text-red-600 hoverEff
                                      "
                                      />
                  ...
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        <span>Discount</span>
                        <PriceFormatter
                          amount={getSubtotal() - getTotalPrice()}
                        />
                      </div>
                      <Separator />
                      <div className="flex justify-between">
