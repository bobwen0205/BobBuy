    ...
    <Container className="py-10 flex flex-col md:flex-row gap-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2.5 lg:gap-5">
          <AddToCartButton
            product={product}
            className="w-full bg-darkColor/80 text-white hover:bg-darkColor hoverEffect"
          />
          <button className="border-2 border-darkColor/30 text-darkColor/60 px-2.5 py-1.5 hover:text-darkColor hover:border-darkColor hoverEffect">
