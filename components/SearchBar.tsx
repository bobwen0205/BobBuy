        ...
        <DialogHeader>
          ...
          <form className="relative" onSubmit={(e) => e.preventDefault()}>
            ...
            {search && (
              <X
                onClick={() => setSearch("")}
                className="w-4 h-4 absolute top-3 right-11 hover:text-red-600"
              />
            )}
            <button
              type="submit"
          ...
          <div>
            {loading ? (
              <p className="flex items-center px-6 py-10 gap-1 text-center text-yellow-600 font-semibold">
                <Loader2 className="w-5 h5 animate-spin" />
                ...
                >
                  <div className="flex items-center gap-1">
                    <Link
                      ...
                      className="h20 w-20 md:h-24 md:w-24 flex-shrink-0 border border-darkColor/20 rounded-md overflow-hidden group"
              ...
              <div className="text-center py-10 font-semibold tracking-wide">
                {search && !loading ? (
                  ...
                  <p className="text-green-600 flex items-center justify-center gap-1">
                    <Search className="w-5 h5 " />
                    Search and explore your products from BobBuy.
                  </p>
                )}
              </div>
            )}
